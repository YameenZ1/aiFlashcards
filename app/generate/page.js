...
export default function Generate() {
    ...
    const saveFlashcards = async () => {
        ...
        const batch = writeBatch(db); // Ensure 'db' is defined and refers to your Firestore instance
                                        ...
                                        <CardContent>
                                            <Box sx={{
                                                ...
                                                '& > div': {
                                                    ...
                                                    position: 'relative', // Fixed from 'related'
                                                    width: '100%',
                                                    height: '100%', // Changed to 100% to fit the card height
                                                    boxShadow: '0 4px 8px 0 rgba(0,0,0,0.2)', // Fixed rgba typo
